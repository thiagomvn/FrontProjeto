...
function Menu() {
    ...
    return(
        <div className="links">
            ...
            <Modal isOpen={loanModalOpen} onRequestClose={closeEditModal}>
                <h2>Meus Empréstimos</h2>
                {loans.map(loan => (
                    <div key={loan.id_loan}>
                        <p>Book: {loan.book_detail.book_name}</p>
                        <button onClick={() => deleteLoan(loan.id_loan)}>Delete</button>
                    </div>
                ))}
            ...
            <Modal isOpen={authorModalOpen} onRequestClose={closeAuthorModal}>
                ...
                {authors.map(author => (
                    <div key={author.id_author}>
                        ...
                        <button onClick={() => deleteAuthor(author.id_author)}>Deletar</button>
